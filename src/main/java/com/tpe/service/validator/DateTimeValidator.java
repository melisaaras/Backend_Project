...
public class DateTimeValidator {
    ...
    // !!! talep edilen ders programları ile mevcut ders programlarını karşılaştırır.Eğer başlangıç saatleri ve
    //  günleri aynı olan bir çift bulunursa BadRequestException fırlatılır, çünkü aynı ders programı birden
    //  fazla kez eklenemez.
}
