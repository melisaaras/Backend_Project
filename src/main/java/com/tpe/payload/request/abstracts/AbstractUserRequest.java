...
//kullanıcıya dair temel bilgileri ve bu bilgilerin doğrulama kurallarını içerir.
// kullanıcı ile ilgili çeşitli bilgilerin saklanması ve doğrulanması için kullanılır ve genellikle veri transferi (DTO) ve istemci tarafı taleplerinin işlenmesi için kullanılır.
...
public abstract class AbstractUserRequest {
    ...
    @Past(message = "Your birthday can not be in the future") //@Past anno. ile girilen tarihin bugünden daha eski olması kontrolü sağlanır
