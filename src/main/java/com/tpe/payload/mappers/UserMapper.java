...
public class UserMapper {
    ...
    //userrequesti usera çevirme yani dtoyu pojoya çevirme
    public User mapUserRequestToUser(BaseUserRequest userRequest){ //BaseUserRequest parametreye yazmamızın sebebi, geniş evrensel class olmasıdır. teacher request ya da student request de gönderilse baseuserrequest hepsini kapsamış olacak
        return User.builder()
